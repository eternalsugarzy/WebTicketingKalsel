...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2025 at 03:57 AM
...
INSERT INTO `tbl_objek_wisata` (`id_objek`, `id_kabupaten`, `nama_objek`, `alamat`) VALUES
(1, 10, 'Pantai Takisung', 'Jl Raya Takisung, Kec Takisung, Kabupaten Tanah Laut'),
(2, 12, 'Museum Lambung Mangkurat', 'Jl. A. Yani No.Km. 36, Loktabat Utara, Kec. Banjarbaru Utara, Kota BanjarBaru'),
(3, 2, 'Pasar Terapung Lok Baintan', 'Jl. Desa Lok Baintan, Sungai Tandipah, Kec. Sungai Tabuk'),
(5, 13, 'Menara Pandang Banjarmasin', 'Jl. Kapten Tendean, Gadang, Banjarmasin'),
(6, 13, 'Pasar Terapung Siring Tendean', 'Jl. Kapt. Pierre Tendean, Banjarmasin'),
(7, 12, 'Danau Seran', 'Guntung Manggis, Banjarbaru'),
(8, 2, 'Bukit Matang Kaladan', 'Aranio, Kec. Aranio, Kab. Banjar'),
(9, 4, 'Air Terjun Haratai (Loksado)', 'Loksado, Hulu Sungai Selatan'),
(10, 4, 'Pemandian Air Panas Tanuhi', 'Tanuhi, Loksado, Hulu Sungai Selatan'),
(11, 5, 'Pagat Batu Benawa', 'Pagat, Batu Benawa, Hulu Sungai Tengah'),
(12, 7, 'Pantai Gedambaan', 'Sarang Tiung, Kec. Pulau Laut Utara, Kotabaru'),
(13, 7, 'Pulau Samber Gelap', 'Pulau Sebuku, Kotabaru'),
(14, 9, 'Pantai Angsana', 'Angsana, Kec. Angsana, Tanah Bumbu'),
(15, 8, 'Air Terjun Lano', 'Lano, Kec. Jaro, Tabalong'),
(16, 1, 'Taman Hijau Balangan', 'Paringin Selatan, Balangan'),
(17, 11, 'Goa Batu Hapu', 'Batu Hapu, Kec. Hatungun, Tapin'),
(18, 3, 'Pulau Kembang', 'Pulau Alalak, Barito Kuala'),
(19, 10, 'Pantai Joras', 'Joras, Kec. Jorong, Tanah Laut'),
(20, 10, 'Bukit Birah', 'Jl Raya Batakan, Kec Kandangan Lama, Tanah Laut');
...
--
ALTER TABLE `tbl_harga_tiket`
  MODIFY `id_harga` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;

--
-- AUTO_INCREMENT for table `tbl_jenis_tiket`
--
ALTER TABLE `tbl_jenis_tiket`
  MODIFY `id_jenis_tiket` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tbl_objek_wisata`
  MODIFY `id_objek` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
