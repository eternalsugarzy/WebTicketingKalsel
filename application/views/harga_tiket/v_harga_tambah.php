      ...
      <div class="col-md-8">
        <div class="card shadow-sm">
          <div class="card-header">
            <h5>Form Atur Harga Tiket Baru</h5>
          </div>
          <div class="card-body">
            
            <?php echo form_open('harga_tiket/proses_tambah'); ?>
              ...
              <div class="mb-3">
                ...
                <select class="form-select" id="id_objek" name="id_objek">
                  ...
                  <?php foreach ($objek_wisata as $objek) : ?>
                    <option value="<?php echo $objek['id_objek']; ?>" <?php echo set_select('id_objek', $objek['id_objek']); ?>>
              ...
              <div class="mb-3">
                ...
                <select class="form-select" id="id_jenis_tiket" name="id_jenis_tiket">
                  ...
                  <?php foreach ($jenis_tiket as $tiket) : ?>
                    <option value="<?php echo $tiket['id_jenis_tiket']; ?>" <?php echo set_select('id_jenis_tiket', $tiket['id_jenis_tiket']); ?>>
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="harga" name="harga" 
                       value="<?php echo set_value('harga'); ?>" placeholder="Contoh: 10000">
