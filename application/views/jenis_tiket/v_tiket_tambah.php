      ...
      <div class="col-md-6">
        <div class="card shadow-sm">
          <div class="card-header">
            <h5>Form Tambah Kategori Tiket</h5>
          </div>
          <div class="card-body">
            
            <?php echo form_open('jenis_tiket/proses_tambah'); ?>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_tiket" name="nama_tiket" 
                       value="<?php echo set_value('nama_tiket'); ?>" 
                       placeholder="Contoh: Dewasa, Anak, Mahasiswa, Rombongan...">
