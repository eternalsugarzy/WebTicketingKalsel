      ...
      <div class="col-md-8">
        <div class="card shadow-sm">
          <div class="card-header">
            <h5>Form Tambah Objek Wisata</h5>
          </div>
          <div class="card-body">
            ...
            <?php echo form_open_multipart('objek_wisata/proses_tambah'); ?>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_objek" name="nama_objek" 
                       value="<?php echo set_value('nama_objek'); ?>">
              ...
              <div class="mb-3">
                ...
                <select class="form-select" id="id_kabupaten" name="id_kabupaten">
                  ...
                  <?php foreach ($kabupaten as $kab) : ?>
                    <option value="<?php echo $kab['id_kabupaten']; ?>" <?php echo set_select('id_kabupaten', $kab['id_kabupaten']); ?>>
